from core.torrent.searcher import search_all, search_movies, search_series, search_games, TorrentResult
...
__all__ = [
    "search_all", "search_movies", "search_series", "search_games", "TorrentResult",
