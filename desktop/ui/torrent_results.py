...
from core.torrent import TorrentResult, search_all, search_games, ContentInfo
...
class TorrentResultsDialog(ctk.CTkToplevel):
    ...
    def _search(self, query: str | None = None) -> None:
        ...
        def task():
            ...
            # Oyun modunda ya da sonuç yoksa oyun araması yap
            if self.show_games and not results:
    ...
    def _add_result_row(self, result: TorrentResult) -> None:
        ...
        icon = "🎮" if result.category == "game" else "🎬"
        meta_parts = [
            f"{icon} {result.quality}",
